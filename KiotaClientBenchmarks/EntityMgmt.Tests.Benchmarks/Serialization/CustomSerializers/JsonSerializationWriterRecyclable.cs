...
/// <summary>
/// Custom JsonSerializationWriter using RecyclableMemoryStream for reduced GC pressure.
/// Based on Microsoft.Kiota.Serialization.Json.JsonSerializationWriter but with memory pooling.
/// </summary>
public class JsonSerializationWriterRecyclable : ISerializationWriter
{
    private readonly MemoryStream _stream;
    private readonly Utf8JsonWriter _writer;
    private bool _disposed;

    public JsonSerializationWriterRecyclable()
    {
        // Use RecyclableMemoryStream instead of new MemoryStream()
        _stream = RecyclableMemoryStreamManager.Instance.GetStream("JsonSerialization");
